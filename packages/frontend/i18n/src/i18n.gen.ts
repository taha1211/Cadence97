...
export function useAFFiNEI18N(): {
    ...
    Enable(): string;
    /**
      * `Enable Cadence97 Sync`
      */
    ["Enable AFFiNE Cloud"](): string;
    /**
      * `Your workspace will be synced and backed up with Cadence97 Sync.`
      */
    ["Enable AFFiNE Cloud Description"](): string;
    /**
      * `Some features need Cadence97 Sync. Web workspaces are saved in this browser and may be removed automatically when disk space is low. Enable Cadence97 Sync to keep this workspace safer and available across devices.`
      */
    ...
    /**
      * `You've got the latest version of Cadence97.`
      */
    ...
    /**
      * `Answer questions, draft docs, visualize ideas - Cadence97 AI can save you time at every possible step. Powered by GPT's most powerful model.`
      */
    ["com.affine.ai-onboarding.general.2.description"](): string;
    /**
      * `Chat with Cadence97 AI`
      */
    ...
    /**
      * `To use Cadence97 AI, please sign in to your Cadence97 Cloud account.`
      */
    ...
    /**
      * `Cadence97 AI is loading history...`
      */
    ...
    /**
      * `Blueberry`
      */
    ["com.affine.appearanceSettings.accent.blueberry"](): string;
    /**
      * `Tints the window around your documents. Your documents keep their own colours.`
      */
    ["com.affine.appearanceSettings.accent.description"](): string;
    /**
      * `Flamingo`
      */
    ["com.affine.appearanceSettings.accent.flamingo"](): string;
    /**
      * `Grape`
      */
    ["com.affine.appearanceSettings.accent.grape"](): string;
    /**
      * `Graphite`
      */
    ["com.affine.appearanceSettings.accent.graphite"](): string;
    /**
      * `Lagoon`
      */
    ["com.affine.appearanceSettings.accent.lagoon"](): string;
    /**
      * `Matcha`
      */
    ["com.affine.appearanceSettings.accent.matcha"](): string;
    /**
      * `Tangerine`
      */
    ["com.affine.appearanceSettings.accent.tangerine"](): string;
    /**
      * `Accent colour`
      */
    ["com.affine.appearanceSettings.accent.title"](): string;
    /**
    ...
    /**
      * `Edit all Cadence97 theme variables here`
      */
    ...
    /**
      * `Customize your Cadence97 appearance`
      */
    ...
    /**
      * `Display the menubar app in the tray for quick access to Cadence97 or meeting recordings.`
      */
    ...
    /**
      * `Open Cadence97 when left‑clicking the tray icon.`
      */
    ...
    /**
      * `Minimize Cadence97 to the system tray.`
      */
    ...
    /**
      * `Close Cadence97 to the system tray.`
      */
    ...
    /**
      * `Start Cadence97 minimized to the system tray.`
      */
    ...
    /**
      * `Congratulations! You have successfully updated the email address associated with your Cadence97 account.`
      */
    ...
    /**
      * `Requires Cadence97 desktop app version 0.18 or later.`
      */
    ...
    /**
      * `Welcome to Cadence97, you're almost there!`
      */
    ...
    /**
      * `Your password has been updated! You can sign in to Cadence97 with the new password.`
      */
    ...
    /**
      * `Your password has been saved! You can sign in to Cadence97 with email and password.`
      */
    ...
    /**
      * `The app will automatically open or redirect to the web version. If you encounter any issues, you can also click the button below to manually open the Cadence97 app.`
      */
    ...
    /**
      * `You have successfully signed in. The app will automatically open or redirect to the web version. if you encounter any issues, you can also click the button below to  manually open the Cadence97 app.`
      */
    ...
    /**
      * `You have signed in to Cadence97.`
      */
    ...
    /**
      * `Your workspace is saved in this browser. When disk space is low, the browser may remove it automatically. Enable Cadence97 Sync to keep it safer.`
      */
    ...
    /**
      * `Host by Cadence97.Pro, Save, sync, and backup all your data.`
      */
    ...
    /**
      * `Enable Cadence97 Sync for {{workspaceName}}`
      */
    ...
    /**
      * `Version history can't work with local workspace. Enable Cadence97 Sync for this workspace to use version history.`
      */
    ["com.affine.history-vision.tips-modal.description"](): string;
    /**
      * `Version history needs Cadence97 Sync`
      */
    ...
    /**
      * `Import your Bear note backup. Tags will be converted to Cadence97 tags and folders.`
      */
    ...
    /**
      * `This format importer is available in the Cadence97 desktop app.`
      */
    ...
    /**
      * `Import your Cadence97 workspace and page snapshot file.`
      */
    ...
    /**
      * `Import your Cadence97 db file (.affine)`
      */
    ...
    /**
      * `Your document has been imported successfully, thank you for choosing Cadence97. Any questions please feel free to feedback to us`
      */
    ...
    /**
      * `Check out Cadence97 for notes, whiteboards, docs, and AI.`
      */
    ...
    /**
      * `Start Cadence97 without an account`
      */
    ...
    /**
      * `Cadence97 Sync keeps your workspace backed up, available across devices, and ready for collaboration and publishing.`
      */
    ["com.affine.nameWorkspace.affine-cloud.description"](): string;
    /**
      * `Sync across devices with Cadence97 Sync`
      */
    ...
    /**
      * `Enter a link to websites or Cadence97 docs. Useful for connecting to external resources and referencing internal docs.`
      */
    ...
    /**
      * `Congratulations on your successful purchase of Cadence97 AI! You're now empowered to refine your content, generate images, and craft comprehensive mindmaps directly within Cadence97 AI, dramatically enhancing your productivity.`
      */
    ...
    /**
      * `If you end your subscription now, you can still use Cadence97 AI until the end of this billing period.`
      */
    ...
    /**
      * `Are you sure you want to resume the subscription for Cadence97 AI? This means your payment method will be charged automatically at the end of each billing cycle, starting from the next billing cycle.`
      */
    ...
    /**
      * `You have purchased Cadence97 AI. The expiration date is {{end}}.`
      */
    ["com.affine.payment.ai.billing-tip.end-at"](options: {
        readonly end: string;
    }): string;
    /**
      * `You have purchased Cadence97 AI. The next payment date is {{due}}.`
      */
    ...
    /**
      * `Please tell us more about your use case, to make Cadence97 better.`
      */
    ...
    /**
      * `Everything in Cadence97 FOSS & Basic.`
      */
    ...
    /**
      * `We'd like to hear more about where we fall short, so that we can make Cadence97 better.`
      */
    ...
    /**
      * `Dedicated Discord support with Cadence97 makers`
      */
    ...
    /**
      * `Upgrade to Cadence97 Pro for expanded member capacity`
      */
    ...
    /**
      * `You can still use Cadence97 Cloud Pro until the end of this billing period :)`
      */
    ["com.affine.payment.modal.downgrade.caption"](): string;
    /**
      * `Keep Cadence97 Cloud Pro`
      */
    ...
    /**
      * `This is the pricing plans of Cadence97 Cloud. You can sign up or sign in to your account first.`
      */
    ...
    /**
      * `We'd like to hear more about your use case, so that we can make Cadence97 better.`
      */
    ...
    /**
      * `Congratulations! Your Cadence97 account has been successfully upgraded to a Pro account.`
      */
    ...
    /**
      * `Thank you for purchasing the Cadence97 self-hosted license.`
      */
    ...
    /**
      * `Doc analytics over 7 days require an Cadence97 Team subscription.`
      */
    ...
    /**
      * `Open this doc in Cadence97 app`
      */
    ...
    /**
      * `Enable the powerful AI assistant, Cadence97 AI.`
      */
    ...
    /**
      * `Enable Cadence97 Sync to collaborate with others`
      */
    ...
    /**
      * `Cadence97 will generate meeting notes by recording your meetings. Authorization to "Screen & System Audio Recording" is necessary.`
      */
    ...
    /**
      * `Use workspace provider keys before Cadence97 AI plan routes.`
      */
    ...
    /**
      * `Upgrade this workspace to add provider keys and route Cadence97 AI through your own OpenAI, Anthropic, Gemini, or FAL account.`
      */
    ...
    /**
      * `Available in the Cadence97 desktop app.`
      */
    ...
    /**
      * `Transcript and workspace indexing require a server Gemini BYOK key or Cadence97 AI plan fallback.`
      */
    ["com.affine.settings.workspace.byok.warning.transcript"](): string;
    /**
      * `Workspace indexing requires a server Gemini BYOK key or Cadence97 AI plan fallback.`
      */
    ...
    /**
      * `Choose where the key is stored, then select the models Cadence97 may use.`
      */
    ...
    /**
      * `Meetings allows you to record and transcribe meetings. Don't forget to enable it in Cadence97 settings.`
      */
    ...
    /**
      * `Enable Cadence97 Sync to publish this workspace`
      */
    ...
    /**
      * `Allow Cadence97 AI Assistant`
      */
    ["com.affine.settings.workspace.affine-ai.label"](): string;
    /**
      * `Allow workspace members to use Cadence97 AI features. This setting doesn't affect billing. Workspace members use Cadence97 AI through their personal accounts.`
      */
    ...
    /**
      * `Manage Cadence97 indexing and Cadence97 AI Embedding for local content processing`
      */
    ...
    /**
      * `Sharing docs requires Cadence97 Sync.`
      */
    ...
    /**
      * `Empower your sharing with Cadence97 Cloud: One-click doc sharing`
      */
    ...
    /**
      * `To ensure compatibility with the updated Cadence97 client, please upgrade your data by clicking the "Upgrade workspace data" button below.`
      */
    ...
    /**
      * `Failed to turn on Cadence97 Sync. Please try again.`
      */
    ...
    /**
      * `Import web pages to Cadence97`
      */
    ["com.affine.integration.web-clipper.desc"](): string;
    /**
      * `Elevate your Cadence97 experience with diverse add-ons and seamless integrations.`
      */
    ["com.affine.integration.setting.description"](): string;
    /**
      * `Learn how to develop a integration for Cadence97`
      */
    ...
    /**
      * `Manually import your content to Cadence97 from Readwise`
      */
    ...
    /**
      * `Once disconnected, content will no longer be imported. Do you want to keep your existing highlights in Cadence97?`
      */
    ...
    /**
      * `New Readwise highlights will be imported to Cadence97 `
      */
    ["com.affine.integration.readwise.setting.sync-new-name"](): string;
    /**
      * `New highlights in Readwise will be synced to Cadence97 `
      */
    ...
    /**
      * `New events will be scheduled in Cadence97’s journal`
      */
    ...
    /**
      * `Enabling this setting allows you to connect your calendar events to your Journal in Cadence97`
      */
    ...
    /**
      * `Enable other MCP Client to search and read the doc of Cadence97.`
      */
    ...
    /**
      * `The server did not respond in time. Cadence97 will keep trying to reconnect.`
      */
...
export const TypedTrans: {
    /**
      * `Go to <a>{{link}}</a> for learn more details about Cadence97 AI.`
      */
    ...
    /**
      * `This is an Cadence97 server hosted by you or your team. After signing in, workspace data is saved to the Cadence97 server you enter, not to Cadence97 Cloud. <1>Learn more about self-hosting.</1>`
      */
    ["com.affine.auth.sign.add-selfhosted.description"]: ComponentType<TypedTransProps<Readonly<{}>, {
        ["1"]: JSX.Element;
    }>>;
    /**
      * `By clicking “Continue with Google/Email” above, you acknowledge that you agree to Cadence97's <1>Terms of Conditions</1> and <3>Privacy Policy</3>.`
      */
    ...
    /**
      * `This demo is limited. <1>Download the Cadence97 Client</1> for the latest features and Performance.`
      */
    ...
    /**
      * `Utilize the meeting notes and AI summarization features provided by Cadence97. <1>Discuss more in the community</1>.`
      */
    ...
    /**
      * `Import your Readwise highlights to Cadence97. Please visit Readwise, <br />click <a>"Get Access Token"</a>, and paste the token below.`
      */
